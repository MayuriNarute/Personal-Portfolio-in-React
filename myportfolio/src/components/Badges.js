      ...
      <section class="features_area section_gap">
        <div class="container justify-content-center">
          ...
          <Collapse in={isSkillsVisible} className="drop">
            ...
            <div class="row feature_inner" style={{ textAlign: "center" }}>
          ...
          <h4 class="mb-4">
            <li class="list-item">
              ...
              View {isSkillsVisible2 ? <FontAwesomeIcon icon={faAngleUp} /> : <FontAwesomeIcon icon={faAngleDown} />}
          ...
          <Collapse in={isSkillsVisible2} className="drop">
            ...
            <div class="row feature_inner" style={{ alignItems: "center" }}>
              <div class="col-lg-3 col-md-6">
          ...
          <h4 class="mb-4">
            <li class="list-item">
              <span>
                <Icon icon="simple-icons:leetcode" width="30" />
                &nbsp;Leetcode Badges
              </span>
              <span class="span4" onClick={toggleLeetcode}>
              View {isSkillsVisible3 ? <FontAwesomeIcon icon={faAngleUp} /> : <FontAwesomeIcon icon={faAngleDown} />}
              </span>
            </li>
          </h4>
...
<section class="features_area">
      ...
      <div class="row feature_inner justify-content-center">
          ...
          <h4 class="mb-4">
            <li class="list-item">
              <span>
                <Icon icon="simple-icons:codechef" width="30" />
                &nbsp;Codechef Badges
              </span>
              <span class="span4" onClick={toggleCodechef}>
              View {isSkillsVisible4 ? <FontAwesomeIcon icon={faAngleUp} /> : <FontAwesomeIcon icon={faAngleDown} />}
